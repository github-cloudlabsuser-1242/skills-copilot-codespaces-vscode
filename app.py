...
def calculator():
    ...
    Note:
    - If the user enters an invalid choice, the function will print "Invalid input".
    - The function assumes that the user will enter valid numbers for the arithmetic operations.
